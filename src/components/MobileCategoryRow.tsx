    ...
    return (
        <div style={style} className="relative overflow-hidden rounded-lg mb-2">
            ...
            <motion.div
                ...
                style={{ x, touchAction: "pan-y", cursor: childCount && childCount > 0 ? "pointer" : "default" }}
            ...
            >
                ...
                <div className="shrink-0 flex flex-col items-end gap-0.5">
                    <div className={`text-[10px] px-2 py-1 rounded-full uppercase font-medium tracking-wider ${getTypeColor(category.type)}`}>
                        {t(category.type)}
                    </div>
